...
# ╔═╡ 7ec562fc-90b4-498e-b398-3700c4b5ad6e
?
...
- Emoji can be used similarly. Unfortunately, the author of this manual is too boring to appreciate this. `😒 = true` and $x^2 = 4$ makes sense.
...
# ╔═╡ a45343f4-c344-4428-b338-d9f1570a05c5
f(x) = 2*x

# ╔═╡ a151d910-5408-40cc-a352-2eeef5434551
f(3,4)

# ╔═╡ e1bcb714-7dab-49bd-9907-595f86c363f5
f(3.3)
...
# ╔═╡ f967914a-c006-4025-93ac-f5ce9ad26182
+(A,A)
...
# ╔═╡ 4027dd2c-e7e4-4eff-aac7-49af1a183a1b
foo(x, y, z) = x + 2y + z

# ╔═╡ 989fa20e-3665-4a27-9b2a-c93d479e778b
foo(b...)

# ╔═╡ 58d27a2d-35a5-4d7a-8ca0-731c462884af
foo(A...)
...
# ╔═╡ 98842bb3-2785-4477-ac29-da4461a454b4
digits(432)

# ╔═╡ 3a0ebfe0-a152-47d5-b4b1-6d359c25edfa
String(['a', 's', 'd', 'f', Char(0x2080+2) ])

# ╔═╡ 81280f50-a601-4033-a4b6-e99fb46adec2
...
# ╔═╡ b9623a57-6731-4c2c-87ef-a768bed67e22
println("asdf"); println("aaaaa"); [println(x) for x ∈ 1:4]

# ╔═╡ 894d8fb6-6cff-481d-bbdc-8f4377225d39
...
# ╔═╡ f244b5bf-24b0-4e86-b1e8-5e9cf9736291
@multiple(3 Expr(:call, :println, "asdf"))

# ╔═╡ 9b6b6be2-e89c-4c46-b935-1ddbf51ad68e
@multiple(3, :('h'))

# ╔═╡ 221fb57d-5095-4115-9604-151fef6d80f0
bar = :(asdf + asdf2); typeof(bar); esc(bar)

# ╔═╡ 07faa84b-8048-413c-9782-bb22f223408f
@macroexpand(@multiple(3, :(x+=1)))

# ╔═╡ 18340cee-a18a-4484-9351-aa80b92ce1f3
@macroexpand(@multiple(10,"aaa"))

# ╔═╡ c04ac764-7037-4509-a7aa-6e900cfbfea5
quote $([1,2,3]) end
...
# ╔═╡ 27245977-6135-4ec1-97a7-686b077e3680
@macroexpand(@pt :header = ["Player $i" for i = 1:4] M)
...
# ╔═╡ 7080f777-1edd-4b6c-a556-c5552d67b27f
b = [1,2,3]; p.(b)
