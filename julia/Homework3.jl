...
# ╔═╡ 8b51a0ce-3b14-43a6-9c89-0b86fa824003
[1; 2 ; 3]
...
# ╔═╡ d3a89f21-b6a6-4c0b-9e63-189c2082f7e0
rand(Float64, 5)

# ╔═╡ dc8a1b01-c59b-47b2-94f5-8d3b73ae2a61
rand(Int, 5)

# ╔═╡ f60ad56a-bea1-40a4-a0b7-ddaed55dd3cd
rand((4, 2))
...
# ╔═╡ 90ca12bf-0e0f-4e5f-a3e9-d0873d81dca0
text = "Crème brûlée est mon"; (lowercase ∘ unaccent)(text)
...
# ╔═╡ e4fa60bd-24b6-4b1d-abbc-5ebb6ac0a9cb
count(["a", "b"], "abcabbbbdef")
...
# ╔═╡ 3eb82fb8-c12f-451f-8a24-052be033d6f3
for i in 1:5 
	print(i)
end
	

# ╔═╡ 30d11adf-9d0c-4111-a104-0b17ce0642f3
begin
	outs = []
...
# ╔═╡ 4482172d-59ee-4aba-a297-46877fdbb6c6
...
# ╔═╡ 6d4da164-2b4f-40f0-9fdf-ffef135eae03
foo = [i*j for i in 1:5, j in 4:6]; foo

# ╔═╡ 528d0998-6085-4f2a-9055-ee586ded6ef3
foo[3, :]
...
# ╔═╡ a6221fb1-6bb0-44a8-9eb9-31477ca64cec
string('a', 'b', 'c')
...
# ╔═╡ 94938256-c7a2-4dc4-bf6c-aa05f21b97d9
diag(sample_freq_matrix) .!= 0.0

# ╔═╡ 65c92cac-f930-11ea-20b1-6b8f45b3f262
double_letters = alphabet[findall(diag(sample_freq_matrix) .!= 0.0)]
...
# ╔═╡ 91357649-1844-450a-8891-a295ba967fd6


# ╔═╡ 5aab3416-3b5d-4031-bb9e-5268f33effe5


# ╔═╡ 9f41ce74-b6ec-4502-bcbd-443e6c80a882
first_sample

# ╔═╡ 24fd0ea4-cd0e-4abc-8d24-043b2780a528
alphabet

# ╔═╡ 8956b5c0-e416-4133-a81c-10b358bd1ed9
alphabet[findall(sample_freq_matrix[23, :] .!= 0)]

# ╔═╡ 7898b76a-f930-11ea-2b7e-8126ec2b8ffd
most_likely_to_follow_w = alphabet[argmax(sample_freq_matrix[23, :])]
...
most_likely_to_precede_w = alphabet[argmax(sample_freq_matrix[:, 23])]
...
# ╔═╡ 3d892008-2962-4b48-9e51-5554486013fc
...
# ╔═╡ 32788901-cd69-435d-b710-e9415fbe9067
A = rand(Float64, (2,2)); B = rand(Float64, (2,2)); (A .- B).^2

# ╔═╡ 13c89272-f934-11ea-07fe-91b5d56dedf8
function matrix_distance(A, B)

	return sum((A.-B).^2) # do something with A .- B
end
