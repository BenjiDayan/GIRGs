...
# ╔═╡ 31bf2428-8078-44fb-aba8-688602e67f37
size_philip2 = [size(philip)[1] - 400, 400]

# ╔═╡ e611c6d7-9ca5-413f-902e-0c2721deede3
@bind row_i2 Slider(2:size_philip2[1] -1, show_value=true)

# ╔═╡ 0ee8216c-8b14-48fa-92f0-993016b3c96b
@bind col_i2 Slider(2:size_philip2[2]-1, show_value=true)

# ╔═╡ 5640de4b-7d44-4946-b39d-56b2a6f12546
red_color = ColorTypes.RGB(255/255, 0, 0)

# ╔═╡ dd5f4d09-c35f-42fb-b9e7-db75567d53d7
begin 
	philip2 = copy(philip)[400:end, 1:400]
	temp = philip2[row_i2, col_i2]
	philip2[row_i2-1:row_i2+1, col_i2-1:col_i2+1] .= red_color
	philip2[row_i2, col_i2] = temp
	philip2
end

# ╔═╡ b18cd9f5-2d6a-49a1-8d6a-9cc54c88045f
philip2[row_i2, col_i2]
...
# ╔═╡ eeaf0628-4262-4686-b4a0-b2fc684bb15b
fieldnames(RGB)

# ╔═╡ 63e8d636-ee0b-11ea-173d-bd3327347d55
function invert(color::AbstractRGB)
	missing = RGB(1-color.r, 1-color.g, 1-color.b)
	return missing
end
...
# ╔═╡ 25a4f6f9-208a-42b8-9242-d915ea09b9a6
let
...
# ╔═╡ e7134e7c-6c15-408b-abcd-5b1bf8a5501a
begin
	function downscale(image, n=5)
		a, b = size(image)
		out = image[1:n:a, 1:n:b]
		i1 = 0
		for i = 1:n:a
			i1 += 1
			j1 = 0
			for j = 1:n:b
				j1 += 1
				# println("i: $i; j: $j")
				window = image[i:min(i+n, a), j:min(j+n, b)]
				out[i1, j1] = +((window/(size(window)[1] * size(window)[2]))...)
...
# ╔═╡ 1add8dd7-050c-4c4b-bb81-1aa48a1c990a
+((window/9)...)
...
# ╔═╡ 4b5e1d06-6904-4795-943d-ade8c4cfde22
@bind r Slider(0:0.01:1, show_value=true)

# ╔═╡ 2049f757-1acd-41a9-b051-fcf8c0e926cd
@bind g Slider(0:0.01:1, show_value=true)

# ╔═╡ ddc725e4-61f2-402d-924d-e4a5b957f138
@bind b Slider(0:0.01:1, show_value=true)

# ╔═╡ fcf7360f-d0bc-4116-b2f1-bb5af1c62174
RGB(r, g, b)
...
# ╔═╡ 27de598f-6040-4a18-a8f0-6e66265d9af1
myface1[1, 1:30]

# ╔═╡ e2ef9fee-52a8-41e5-9e5b-faf22f153651
myface1[1:30, 1]

# ╔═╡ eeb7f951-6a0c-4bba-a904-3cb2b59f645d
size(myface1)

# ╔═╡ 01d33647-ed32-42e7-ad4c-bd4270bb62d6
myface1[50, :]
...
# ╔═╡ ca48c8ca-1d1d-418f-8e19-da2d0c6f75b6
