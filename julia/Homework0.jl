...
student = (name = "Benji D", kerberos_id = "bdayan")
...
ex_1_1 = md"""
√x = r is the unique soln to x/a = a. Hence if we set r' > r, then x/r' < r < r', and conversely setting r' < r then x/r' > r > r'.
""" 
# you might need to wait until all other cells in this notebook have completed running. 
# scroll down the page to see what's up
